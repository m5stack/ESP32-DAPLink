...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_label_1, "DapLink");
	lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_1, 0, 0);
	lv_obj_set_size(ui->screen_label_1, 128, 17);
	...
	lv_obj_set_pos(ui->screen_btn_1, 0, 65);
	lv_obj_set_size(ui->screen_btn_1, 128, 38);
	...
	lv_obj_set_pos(ui->screen_label_2, 0, 20);
